    ...
    foreach ($directories as $dir) {
        ...
        foreach ($template_directory as $template) {
            if (!$template->isDot() && !$template->isDir()) {
                ...
                // Use asset_path on non-null values
                foreach(['enqueue_style', 'enqueue_script', 'enqueue_assets'] as $prop){
                    if($file_headers[$prop]) {
                        $file_headers[$prop] = asset_path($file_headers[$prop]);
                    }
                }
